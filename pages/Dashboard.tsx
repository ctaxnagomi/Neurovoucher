...
import { TunaiCard, TunaiBadge, TunaiButton } from '../components/TunaiComponents';
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <TunaiCard>
          ...
          <div className="mt-4 flex gap-2">
             <TunaiBadge color="text-green-600">+12%</TunaiBadge>
        ...
        <TunaiCard>
          ...
          <div className="text-3xl font-bold text-gray-700 mt-2">14</div>
           <div className="mt-4 flex gap-2">
             <TunaiBadge color="text-orange-600">{t('actionRequired')}</TunaiBadge>
          </div>
        </TunaiCard>
        <TunaiCard>
          ...
          <div className="text-3xl font-bold text-gray-700 mt-2">89</div>
           <div className="mt-4 flex gap-2">
             <TunaiBadge color="text-purple-600">Gemini 3.0</TunaiBadge>
          </div>
        </TunaiCard>
      </div>

      {/* Main Chart Section with Toggles */}
      <TunaiCard className="h-[550px] flex flex-col relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <TunaiCard title={t('recentActivity')}>
