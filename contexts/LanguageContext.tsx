...
const dictionaries: Record<LanguageCode, Record<string, string>> = {
  ...
  ms: {
    ...
    payeeIc: "KP/Pendaftaran Penerima",
    ...
    authFailedDesc: "Kunci API tidak sah atau tiada. Sila semak Tetapan.",
    ...
    newsUpdates: "Berita & Kemaskini",
    eInvoiceConfig: "E-Invois"
  },
  zh: {
    dashboard: "仪表板",
    generator: "凭单生成器",
